...
module Actions::Fusor::Deployment::CloudForms
  class TransferConsumerRpm < Actions::Fusor::FusorBaseAction
    def humanized_name
      _("Transfer Satellite's consumer rpm to CFME machine")
    end
    ...
    def scp_file(deployment, image_file)
      host_address = deployment.cfme_rhv_address || deployment.cfme_osp_address
      user = "root"
      password = deployment.cfme_root_password
